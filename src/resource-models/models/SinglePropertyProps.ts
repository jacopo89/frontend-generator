...
export class SinglePropertyProps{
    ...
    constructor({model, record, formValue, setForm, lockedFormValue, errors, submitHandler, partialSubmitHandler, referencesMap, refreshReferencesMap, showLabel=true}:Props) {
        this.model = model;
        this.record = record;
