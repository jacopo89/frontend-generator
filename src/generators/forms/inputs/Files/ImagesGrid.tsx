...
export const ImagesGrid: React.FC<FilesGridInterface> = ({model,onChange,partialSubmitHandler,modelResourceName, files, resourceId,refresh}) =>{
    ...
    // @ts-ignore
    const list = <ImageGrid images={filesList} onSelect={(index)=>selectElement(index)} onChange={prepareImagesForRequest} filesLimit={10} fileObjects={uploadedLocalFiles} onAdd={addFile} onDelete={removeFile} saveImages={saveImages}/>
