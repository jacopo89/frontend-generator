...
export default function ({ model, formValue, refreshReferencesMap, value: values, createNew, onChange, hasError, errorMessage, dependencies }: ReferenceInput): JSX.Element;
/**
 * @param {int} value
 * @param {array} options
 * @returns {int}
 */
export declare function getAutocompleteValuePosition(value: ListingOption[], options: ReferenceInputOption[]): number[];
export {};
