...
export const FilesList = ({ model, onChange, partialSubmitHandler, modelResourceName, files, resourceId, refresh }) => {
    ...
    // @ts-ignore
    const list = _jsx(FileList, { list: filesList, onChange: prepareImagesForRequest, filesLimit: 10, fileObjects: uploadedLocalFiles, onAdd: addFile, onDelete: removeFile, saveImages: saveImages }, void 0);
